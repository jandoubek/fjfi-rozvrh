...
namespace Rozvrh.Tests.Model
{
    ...
    public class ModelTest
    {
        ...
        private static List<GroupLessonBinder> groupLessonBinder
        {
            get
            {
                return new List<GroupLessonBinder>
                {
                    ...
                    new GroupLessonBinder("3", "3", "26"), //The 1st group of the AMSM (1st year) has LAP
                    new GroupLessonBinder("3", "3", "44"), //The 1st group of the AMSM (1st year) has LAPcv
                    new GroupLessonBinder("3", "4", "26"), //The 2nd group of the AMSM (1st year) has LAP
                    new GroupLessonBinder("3", "4", "28"), //The 2nd group of the AMSM (1st year) has LAPcv
                    new GroupLessonBinder("3", "5", "26"), //The 3rd group of the AMSM (1st year) has LAP
                    new GroupLessonBinder("3", "5", "39"), //The 3rd group of the AMSM (1st year) has LAPcv
                };
            }
        }
